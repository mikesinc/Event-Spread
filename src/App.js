    ...
    return (
        <div>
            ...
            <Container fluid className='overall'>
                ...
                <Container fluid className="IntroFrame">
                    ...
                    <h1><span style={{color: '#00f2ff'}}>_</span>the grazing field</h1>
                ...
                <Container fluid className='events' style={{ display: 'flex', flexDirection: 'column'}}>
                    <h1><span style={{color: '#00f2ff'}}>_</span>grazing platters</h1>
                    <div smooth-parallax="" start-position-x="-0.5" end-movement="0.35">
                        <Eventcard left={true} event='birthdays' text='make their day even more special with a range of sweets and savouries on a display that will blow them away' />
                    </div>
                    <div smooth-parallax="" start-position-x="0.5" end-movement="0.6">
                        <Eventcard left={false} event='weddings' text='ensure the newly wed couple gets a head start on the honeymoon body with this amazing romantic sweets platter' />
                    </div>
                    <div smooth-parallax="" start-position-x="-0.5" end-movement="0.8">
                        <Eventcard left={true} event='baby showers' text='someone having a baby? We cater for themed baby showers (blue or pink) to help brighten your special day' />
                    </div>
                    <div smooth-parallax="" start-position-x="0.5" >
                        <Eventcard left={false} event='custom events' text='got other plans? send us a message with the details of your event and we will do our best to sort something out for you!' />
                    </div>
                </Container>
                <Container fluid className='contact'>
                    <h1><span style={{color: '#00f2ff'}}>_</span>get in touch!</h1>
                    ...
                    <Form action="https://formspree.io/thegrazingfield@gmail.com" method="POST">
                        <Form.Group as={Row}>
                            ...
                            <Col sm={5} lg={3}>
                                <Form.Control style={{color: '#00f2ff'}} onChange={(event) => setUserName(event.target.value)} name="name" placeholder="first" required />
                            </Col>
                        </Form.Group>
                        <Form.Group as={Row}>
                            <Form.Label column sm={{ span: 1, offset: 2 }}></Form.Label>
                            <Col sm={5} lg={3}>
                                <Form.Control style={{color: '#00f2ff'}} name="name" placeholder="last" required />
                            </Col>
                        </Form.Group>
                        <Form.Group as={Row}>
                            <Form.Label column sm={{ span: 1, offset: 2 }}>
                            ...
                            <Col sm={5} lg={3}>
                                <Form.Control style={{color: '#00f2ff'}} type="email" name="_replyto" placeholder="email" required />
                            </Col>
                        </Form.Group>
                        <Form.Group as={Row}>
                            <Form.Label column sm={{ span: 1, offset: 2 }}>
                            ...
                            <Col sm={5} lg={2}>
                                <Form.Control style={{color: '#00f2ff'}} type="tel" name="tel" placeholder="(optional)" />
                            </Col>
                        </Form.Group>
                        <fieldset>
                            <Form.Group as={Row}>
                        ...
                        <Form.Group as={Row}>
                            ...
                            <Col sm={5} lg={2}>
                                <Form.Control style={{color: '#00f2ff'}} type="text" name="guests" placeholder="e.g. 30" />
                            </Col>
                        </Form.Group>
                        <Form.Group id="description">
                            ...
                            <Col sm={{ span: 10, offset: 1 }} lg={{ span: 8, offset: 2 }} >
                                <Form.Control style={{color: '#00f2ff'}} name="description" size="sm" as="textarea" rows="8" placeholder={`tell us about your event... (include things like allergies etc.) \nthis will help us tailor the experience to your needs`} required />
